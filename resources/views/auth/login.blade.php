...
@section('content')
    ...
    <section class="wsus__sign_in">
        <div class="row align-items-center">
            <div class="col-xxl-8 col-xl-9 col-lg-9 wow fadeInLeft">
                <div class="wsus__sign_img">
                    <img src="{{ asset('frontend/assets/images/GFMIQ_logo.png') }}" alt="login" class="img-fluid">
                    {{-- <a href="index.html">
                        <img src="{{ asset('frontend/assets/images/GFMIQ_logo.png') }}" alt="EduCore" class="img-fluid">
                    </a> --}}
                </div>
            </div>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                            ...
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <p class="new_user">Welcome back! Please enter your credentials to sign in.</p>
                                <div class="row">
                                    <div class="col-xl-12">
