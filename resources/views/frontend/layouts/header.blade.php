    ...
    <nav class="navbar navbar-expand-lg main_menu main_menu_3">
        <a class="navbar-brand" href="{{ url('/') }}">
            <img src="{{ asset(config('settings.site_logo')) }}" alt="GFMIQ" class="img-fluid">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav m-auto">
                ...
                @foreach ($customPages as $page)
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('custom-page/' . $page->slug) ? 'active' : '' }}"
            ...
            <div class="right_menu">
                ...
                <ul>
                    ...
                    <li>
                        @if(auth()->check())
                        <a class="common_btn" href="{{ route('logout') }}"
                        ...
                        @else
                        <a class="common_btn" href="{{ route(request()->routeIs('register') ? 'login' : 'register') }}">
