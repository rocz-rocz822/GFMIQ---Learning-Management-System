                    ...
                    <div class="wsus__sidebar">
                        <form action="{{ route('courses.index') }}">
                            ...
                            <div class="wsus__sidebar_course_lavel">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="{{ $level->id }}" name="level[]" id="level-{{ $level->id }}"
                            ...
                            <!-- <div class="wsus__sidebar_course_lavel rating">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="5" name="rating[]" id="flexCheckDefaultr1"
                                        @checked(in_array('5', $selectedRatings))>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="4" name="rating[]" id="flexCheckDefaultr2"
                                        @checked(in_array('4', $selectedRatings))>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="3" name="rating[]" id="flexCheckDefaultr3"
                                        @checked(in_array('3', $selectedRatings))>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="2" name="rating[]" id="flexCheckDefaultr4"
                                        @checked(in_array('2', $selectedRatings))>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" name="rating[]" id="flexCheckDefaultr5"
                                        @checked(in_array('1', $selectedRatings))>
